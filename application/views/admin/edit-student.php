...
<head>
    ...
    <title>ተማሪ አርታዒ | ሰንበት አቴንዳንስ ሲስተም</title>
    <!-- Boxicons -->
            ...
            <div class="unique-form-container">
                ...
                <div class="unique-form-grid">
                    ...
                    <div class="unique-form-group">
                        ...
                        <input type="text" id="repentance_father" name="repentance_father" value="<?php echo set_value('repentance_father', $student['repentance_father']); ?>" >
                    </div>
                    ...
                    <div class="unique-form-group" id="department_group">
                        <label for="department_id">የአገልግሎት ክፍል </label>
